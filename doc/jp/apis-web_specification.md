...
| **日付**  | **Rev.** | **担当** | **変更内容**                 |
|-----------|----------|----------|------------------------------|
| 2020/4/13 | 0.5      | 岩瀬     | 初回リリース                 |
| 2020/4/15 | 0.51     | 岩瀬     | OES Member Comment修正       |
| 2020/4/16 | 0.6      | 岩瀬     | Symphony Comment修正         |
| 2020/4/17 | 0.61     | 岩瀬     | 第二弾OES Member Comment修正 |
| 2020/4/17 | 0.62     | 岩瀬     | 目次更新                     |
| 2020/4/17 | 0.63     | 岩瀬     | 第三弾OES Member Comment修正 |
| 2020/4/17 | 0.64     | 岩瀬     | “6.情報収集”の収集項目追記   |
|           |          |          |                              |
|           |          |          |                              |
|           |          |          |                              |
|           |          |          |                              |
...
[**4.3.** **Emulator Emulator** 9][]

[**4.4.** **Api Server** 9][]

[**4.4.1.** **Deal Generator** 9][]

[**4.4.2.** **Error Generator** 9][]

[**4.4.3.** **Log Configurator** 10][]

[**5.** **通信仕様について** 11][]

[**5.1.** **Web API** 11][]

[**5.2.** **apis-web – Grid Master間通信** 11][]

[**6.** **収集情報** 12][]

[**6.1.** **Emulator Emulator /get/log** 12][]

[**6.2.** **Budo Emulator /deals** 14][]
...
>
> ・Deal Generator : 意図的に電力融通の実行命令をクラスタ内に生成するための
>
> Web API

・Error Generator : 任意のError処理命令をクラスタ内に生成するためのWeb API

・Log Configurator : apis-mainのコミュニケーションラインへのUDP Log出力の

Levelを動的に変更するための Web API
...
-任意ノード : 電力融通情報取得、Global電力融通Modeステータス取得、

Global 電力融通Mode設定

-個別ノード : Local電力融通Modeステータス取得、Local電力融通Mode設定、
...
→実行中にErrorではないが期待された動作でないため警告として知らせる目的で
...
→実行中の正常系の情報を出力する際に用いられるLevelで、apis-webでは特に

動作として重要なイベント処理を行った際に使われる。
...
　　→特定の処理についての開始及び終了の情報であるがapis-webとしてはこのLevelの
